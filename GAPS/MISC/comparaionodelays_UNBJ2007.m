...
g{1}=[ sta '0060_07d.l12'];
g{2}=[ sta '0070_07d.l12'];
g{3}=[ sta '0080_07d.l12'];
g{4}=[ sta '0090_07d.l12'];
g{5}=[ sta '0100_07d.l12'];

r{1}=[ sta '0060_07d.rio'];
r{2}=[ sta '0070_07d.rio'];
r{3}=[ sta '0080_07d.rio'];
r{4}=[ sta '0090_07d.rio'];
r{5}=[ sta '0100_07d.rio'];
...
xlabel('Doy (2004)');
title(['Station ' sta ' - 2007/01/01 to 2007/01/05']);
...
tit=['Station ' sta ' - 2007 doy 001 to 005'];
title(tit);
xlabel('Slant residuals (TECU)');
ylabel('Occurrences');
