...
g{1}=[ sta '0010_07d.l12'];
g{2}=[ sta '0020_07d.l12'];
g{3}=[ sta '0030_07d.l12'];
g{4}=[ sta '0040_07d.l12'];
g{5}=[ sta '0050_07d.l12'];

r{1}=[ sta '0010_07d.rio'];
r{2}=[ sta '0020_07d.rio'];
r{3}=[ sta '0030_07d.rio'];
r{4}=[ sta '0040_07d.rio'];
r{5}=[ sta '0050_07d.rio'];
...
figure;
plot(res(:,1)/86400,res(:,2),'r','linewidth',2);
hold on
plot(res(:,1)/86400,res(:,4),'.');
grid on;
ylabel('Ionospheric delay (TECU)');
xlabel('Time (days)');
title(['Station ' sta ' - 2007/01/02 to 2007/01/05']);
...
title(['Station ' sta ' - 2007/01/02 to 2007/01/05']);
subplot(3,1,2);
scatter(re(:,1)/86400,re(:,9)/0.162372447511995,10,re(:,7));
grid on;
ylabel('Slant Residuals (TECU)');
xlabel('Time (days)');
subplot(3,1,3);
scatter(re(:,1)/86400,re(:,9)/0.162372447511995.*sin(re(:,8)),10,re(:,7));
grid on;
...
tit=['Station ' sta ' - 2007 doy 002 to 005'];
title(tit);
xlabel('Slant residuals (TECU)');
ylabel('Occurrences');
