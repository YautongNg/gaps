%
function zennad=zunb3m(recllh,DAYOYEAR)
%
...
%  =================
%
%     This subroutine uses UNB3m model to calculate the ZENITH
%     neutral atmospheric delay for a given latitude, height and 
%     day of year (DOY). 
%
%   How this function works:
%   ------------------------
%
%     1. A look-up table is used to calculate MSL values for 
%        Pressure, Temperature, Relative humidity and lapse 
%        rate parameters (for given latitude and DOY).
%
%     2. MSL Water Vapor Pressure is computed according to
...
%        computed using Saastamoinen formulas.
%
%
%   General Comments:
%   -----------------
...
%     Proceedings of ION NTM 2006, Monterey, California, January,
%     2006.
%
%   Created/Modified
%   ----------------
...
%	DATE		WHO                 WHAT
%	----		---                 ----	
%   2006/01     Rodrigo Leandro     unb3m Function created
%   2006/06     Rodrigo Leandro     zunb3m function created (addapted from
%                                   unb3m function)
%   2006/06     Rodrigo Leandro     Input in vector format (recllh)
%
%   INPUT/OUTPUT
%   ------------
%
...
%     ---------   ---   ----       -----------
%     recllh      IN    DOUBLE     3x1 vector with receiver geodetic
%                                  coordinates
%                                  recllh=[ lat ; lon ; h ]
%                                          (rad) (rad) (m)
...
%     RTROP       OUT   DOUBLE     Total Zenith Delay (M)
%
%=======================================================================
%
%
...
%=======================================================================
% Assign values for Latitude and Height
%-----------------------------------------------------------------------
LATRAD=recllh(1,1);
HEIGHTM=recllh(3,1);
if isnan(LATRAD)
...
%
%=======================================================================
% INITIALISE POINTERS TO LOOKUP TABLE
%-----------------------------------------------------------------------
LAT = abs( LATDEG );
...
%
%=======================================================================
%        compute mean temperature of the water vapor (eq. (21))
%-----------------------------------------------------------------------
TM  = T * (1 - BETA * RD / DEN);
%=======================================================================
%
...
%
%=======================================================================
% COMPUTE SIN OF ELEVATION ANGLE
%-----------------------------------------------------------------------
% SINE = sin(ELEVDEG*DTR);
%=======================================================================
%
%
%=======================================================================
