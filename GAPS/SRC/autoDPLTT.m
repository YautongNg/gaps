...
function autoDPL(obsname,fltname,tp,el,nsd,nrw,nhzg,nrwhg,ot,bt,blqfile,pic)
% autoDPL
% ('alic0010.10o','0','10','0.10','5','-1','-1','1','1','none','emf')/MATLAB
% autoDPL (alic0010.10o 0 10 0.10 5 -1 -1 0 1 none emf) / Executable
