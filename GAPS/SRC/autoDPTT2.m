...
function autoDPTT2(obsname,fltname,tp,el,nsd,nrw,nhzg,nrwhg,ot,bt,blqfile,pic)
% autoDPTT('nrc10010.11d','0','10','0.10','5','-1','-1','1','1','none','emf')/MATLAB
% autoDPTT (usno0010.11d.Z 0 10 0.10 5 -1 -1 1 1 none emf) / Executable
...
[aaa oobsname exten]=fileparts(obsname);    
