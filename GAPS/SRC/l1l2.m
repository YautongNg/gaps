function [cx12 cx0 amb amb1 amb2]= ...
    l1l2(cx0,cx12,prnlist,elvlist,amb,amb1,amb2,l1,l2,p1,p2, ...
    cst,cpsd,otpt12,cdate,rc,ipp,recllh)
%
% Function l1l2
% =============
%
%       This function computes L1/L2 ambiguties and the IONO delay
%
% Sintax
% ======
%
%       [cx12 amb1 amb2]= ...
%    l1l2(cx0,cx12,prnlist,elvlist,amb,amb1,amb2,l1,l2)
%
% Input
% =====
%
...
A=updtdm12(prnlist,cst,ipp,recllh,elvlist);
...
for prnl=1:size(prnlist,1)
    ...
    w=updtmv12(w,l1(prn),l2(prn),p1(prn),p2(prn),amb(prn),amb1(prn),amb2(prn),cst);
